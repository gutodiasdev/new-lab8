(function ($) {
  ...
  function imageSliderSettings () {
    $(".image-slider").each(function () {
      ...
      var itemsToShow = window[id + '_itemsToShow']
      var itemsMargin = window[id + '_margin']
      auto_value = (auto_value === 'true') ? true : false
      hover_pause = (hover_pause === 'true') ? true : false
      itemsToShow = (itemsToShow === null | undefined) ? 1 : itemsToShow
      itemsMargin = (itemsMargin === null) ? 0 : itemsMargin
      $('#' + id).owlCarousel({
        loop: true,
        autoHeight: true,
        smartSpeed: 1000,
